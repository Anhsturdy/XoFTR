...
_CN.XOFTR.RESNET = CN()
_CN.XOFTR.RESNET.INITIAL_DIM = 32
_CN.XOFTR.RESNET.BLOCK_DIMS = [32, 64, 128]  # s1, s2, s3

# 2. XoFTR-coarse module config
_CN.XOFTR.COARSE = CN()
_CN.XOFTR.COARSE.INFERENCE = INFERENCE
_CN.XOFTR.COARSE.D_MODEL = 128
_CN.XOFTR.COARSE.D_FFN = 128
_CN.XOFTR.COARSE.NHEAD = 8
_CN.XOFTR.COARSE.LAYER_NAMES = ['self', 'cross'] * 2
...
_CN.XOFTR.MATCH_COARSE.D_MODEL = 128
...
_CN.XOFTR.FINE.NHEAD_FINE_LEVEL = 4
_CN.XOFTR.FINE.NHEAD_MEDIUM_LEVEL = 4
